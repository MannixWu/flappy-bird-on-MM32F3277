...
int32 speed=1000;
int32 MB_Left_speed=0,MB_Right_speed=0;
...
{
//	speed_read();
//	MB_Left_speed=speed+dir;
//	MB_Right_speed=speed-dir;
//	speed_control(&Left_motor,MB_Left_speed,Left_speed);
//	speed_control(&Right_motor,MB_Right_speed,Right_speed);
//	Left_lun(Left_motor.result);
//	Right_lun(Right_motor.result);
