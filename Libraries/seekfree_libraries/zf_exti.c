...
// @param		trigger			选择触发的信号方式 [EXTI_Trigger_Rising/EXTI_Trigger_Falling/EXTI_Trigger_Rising_Falling]
// @return		void
// Sample usage:				exti_even_init(A00,EXTI_Trigger_Rising);
//-------------------------------------------------------------------------------------------------------------------
...
// @param		pin				选择 EXTI 引脚
// @return		void
// Sample usage:				exti_interrupt_enable(A00);
//-------------------------------------------------------------------------------------------------------------------
...
// @param		pin				选择 EXTI 引脚
// @return		void
// Sample usage:				exti_interrupt_disable(A00);
//-------------------------------------------------------------------------------------------------------------------
...
//  @param		pin				选择 EXTI 引脚
//  @return		void
//  Sample usage:				exti_even_enable(A00);
//-------------------------------------------------------------------------------------------------------------------
...
// @param		pin				选择 EXTI 引脚
// @return		void
// Sample usage:				exti_even_disable(A00);
//-------------------------------------------------------------------------------------------------------------------
